    ...
    <v-container > <!-- fluidを付けることで左右いっぱいにコンテナが広がります -->
        ...
        <v-form
            ...
            <v-list-item three-line>
                    <v-list-item-content>
                    <v-list-item-title class="headline mb-1">アイコン</v-list-item-title>
                        <v-file-input
                            :rules="rules"
            ...
            >
                <v-list-item three-line>
                    <v-list-item-content>
                        <v-list-item-title class="headline mb-1">得意な技術領域</v-list-item-title>
                        <v-form
                        ref="form"
                        v-model="valid"
                        lazy-validation
            ...
            >
                <v-list-item three-line>
                    <v-list-item-content>
                    <v-list-item-title class="headline mb-1">自己紹介</v-list-item-title>
                        <v-textarea
                        counter
